...
class DARPinPoly(DARP):
    ...
    def __init__(self, nx, ny, MaxIter, CCvariation, randomLevel, dcells, importance, notEqualPortions, initial_positions, portions, obstacles_positions, visualization,):
        fck=0
        self.total=len(initial_positions)
        self.total=len(initial_positions)
        ...
        for mode in range(4):
            ...
            for r in range(self.droneNo):
                ...
                if fck<self.total:
                    self.path.append(ct.PathSequence)
                    fck+=1
            ...
            if min_avg > drone_turns.ret_avg():
                self.min_mode=mode
...
if __name__ == '__main__':
    ...
    a=poly.clearPath()
    print(a) #ne baal ekhan theke ne.. 2 to kore pabi eta theke
    #print(poly.path)  #ekhan theke 4 te kore pabi
    no_bot=2
